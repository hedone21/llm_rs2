...
> **Emergency Level의 역할**: Emergency는 D-Bus 경로에서 Engine이 자율적으로 Suspend하는 트리거이다 (SYS-055, SYS-085a). Manager의 OperatingMode(Normal/Warning/Critical)에는 Emergency가 존재하지 않는다.
