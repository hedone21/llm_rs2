...
- **INV-149 / INV-150** (commit-before-read ordering, plan run-to-completion): `WeightSwapStage` Persistent stage 가 PostLayer phase 에서 dispatch + weight precision swap(concrete-handle; 구 `WeightFormat::apply_storage`) 호출 시 동일 정신 보존.
