...
- **(γ-1) `kv/`·`weight/` rename** — `pressure/`→`kv/`, `pressure/weights/`→`weight/`(§2.1 G3-reconcile Q1/Q2). blast radius 189 ref / 53 file(기계적). `Pressure` 타입 ↔ `pressure/` 디렉토리 이름 충돌 해소.
