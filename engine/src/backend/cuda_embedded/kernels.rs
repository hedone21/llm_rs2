...
pub struct CudaKernels {
    ...
    pub mul_mat_q4_0_q8_1_mtile: CudaFunction,
    pub mul_mat_vec_q4_0_q8_1_gate_up_silu: CudaFunction,
}
...
impl CudaKernels {
    ...
    pub fn compile(ctx: &Arc<CudaContext>, cc: (i32, i32)) -> Result<Self> {
        ...
        Ok(Self {
            ...
            mul_mat_q4_0_q8_1_mtile: load("mul_mat_q4_0_q8_1_mtile")?,
            mul_mat_vec_q4_0_q8_1_gate_up_silu: load("mul_mat_vec_q4_0_q8_1_gate_up_silu")?,
        })
    }
