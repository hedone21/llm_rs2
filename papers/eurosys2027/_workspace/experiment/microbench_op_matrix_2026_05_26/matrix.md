...
→ **Ours-NPU**는 1/25 op (RMS_NORM) GREEN. 24/25 op은 init_*_req helper 미구현 = paper "self-built NPU binding scope" evidence.
...
5. **Ours-NPU**는 RMS_NORM + MUL_MAT (Q-proj) 2/25 op proof-of-concept (G2 sprint 2026-05-26 — `init_matmul_req` IDL + microbench + S25 deploy, q4x4x2 weight repack 포함). 23/25 op은 init_*_req helper 미구현 → 본 sprint "self-built NPU binding scope" evidence.
...
| 7  | **UNARY_SILU**          | `[1, 8960]`                                         | 28          | A | TBD | TBD | TBD | ✗ |
| 0  | **MUL** (SiLU·up)       | `[1, 8960]`                                         | 28          | A | TBD | TBD | TBD | ✗ |
| 1  | **ADD** (residual)      | `[1, 1536]`                                         | 56 (2·28)   | A | TBD | TBD | TBD | ✗ |
