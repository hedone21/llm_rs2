...
5. **Ours-NPU**는 RMS_NORM 1/25 op proof-of-concept. 24/25 op은 init_*_req helper 미구현 → 본 sprint "self-built NPU binding scope" evidence.
...
| 4a | **MUL_MAT** Q-proj      | `W[1536,1536] @ x[1536]` Q4_0                       | 28          | A | TBD | TBD | TBD | ✗ |
